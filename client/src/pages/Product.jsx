    ...
    return (
        <>
            <div className="container_product_top">
                <h1 className="header" id="type">Votre prochaine commande</h1>
                    ...
                    <div className="delivery-list">
                        {products.map((product, index) => (
                            <DeliveryProduct 
                                ...
                                img_url={"https://www.purina.fr/sites/default/files/styles/product_380x380/public/2022-01/1.%20MHI%2007613033831287_H1N1_FR_44074316-RESIZED.png?itok=cM3h0tUG"}
                            />
                        ))}
                    </div>
                </div>
            ...
            <div className="container_product_top">
                <h1 className="header" id="type">Notre catalogue</h1>
                <input
                    type="text"
